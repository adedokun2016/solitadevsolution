...
if(isset($_POST['submit'])){
    ...
    $insert_data = "INSERT INTO partialtech(farm_name, date_time, metric_type, metric_value) VALUES('$farm_name','$date_time','$metric_type','$metric_value')";
...
<a href="index.php" class="btn btn-success"><i class="fa fa-home"></i> Home</a>
  ...
  <hr>
        ...
        <thead>
            ...
            $get_data = "SELECT * FROM partialtech  order by id desc ";
...
$get_data = "SELECT * FROM partialtech";
$run_data = mysqli_query($con,$get_data);
