...
if(isset($_POST['submit'])){
    ...
    $insert_data = "INSERT INTO ossi_farm(farm_name, date_time, metric_type, metric_value) VALUES('$farm_name','$date_time','$metric_type','$metric_value')";
...
<a href="index.php" class="btn btn-success"><i class="fa fa-home"></i> Home</a>
  ...
  <hr>
        ...
        <thead>
            ...
            $get_data = "SELECT * FROM ossi_farm  order by id desc ";
...
$get_data = "SELECT * FROM ossi_farm";
$run_data = mysqli_query($con,$get_data);
